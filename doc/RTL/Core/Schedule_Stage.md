...
Here’s the updated table with `sched_perf` as the last parameter:

| Interface Name                     | Description                                                      |
|-------------------------------------|------------------------------------------------------------------|
| `base_dcrs`                       | Input configuration interface for base device control registers. |
| `warp_ctl_if`                     | Slave interface for warp control unit in the execute stage                |
| `branch_ctl_if`                     | Slave interface for controlling branch scheduling across ALU blocks. |
